...
export class SidebarComponent {
  // categorias no mesmo espírito do app React (só ligando as que já existem nas rotas atuais)
  private readonly categories: ToolCategory[] = [
    {
      ...
      tools: [
        ...
        { name: 'UUID Generator', path: '/uuid', disabled: true }, // placeholder
        { name: 'Password Generator', path: '/password', disabled: true }, // placeholder
      ],
    },
    {
      name: 'Utilities',
